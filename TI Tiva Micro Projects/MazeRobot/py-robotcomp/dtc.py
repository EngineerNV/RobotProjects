...
def rotate90(manual_turn = 0):
	...
	if manual_turn != 0 :
		if manual_turn < 0 :
			angle = math.radians(manual_turn)
			manual_turn -= 10
			dist = (-1*manual_turn/360) * (track_width*math.pi)
			print('Manual Turning: ' + str(dist))
			dist = dist * 100
			dist = int(dist)
			print('Manual Turning: ' + str(dist))
			bump_check = turnRight(dist)
			...
			angle = math.radians(manual_turn)
			manual_turn += 10
			dist = (manual_turn/360) * (track_width*math.pi)
			print('Manual Turning: ' + str(dist))
			dist = dist * 100
			dist = int(dist)
			print('Manual Turning: ' + str(dist))
