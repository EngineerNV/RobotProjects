...
def changeSensorThreshold(serialPort, newLeftThreshold, newFrontThreshold, newRightThreshold):
    # Write the command to the microcontroller
    serialPort.write(struct.pack('>BBB',CHANGE_SENSE_THRESHOLD_COMMAND,newLeftThreshold&0xFF,(newLeftThreshold>>8)&0xff,newFrontThreshold&0xFF,(newFrontThreshold>>8)&0xff,newRightThreshold&0xFF,(newRightThreshold>>8)&0xff))
